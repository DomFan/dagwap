      ...
      <form action="" method="">
        <ul class="inp-list" >
          ...
          <div class="res-btn"  v-show="isTrue">
            <mt-button type="primary"    :class='[styles]' @click="changeInput" >下一步</mt-button>
            <!--<Button class="nextStep"  ref="resBtn"   @click="changeInput">下一步</Button>-->
          </div>
      ...
      .inp-list
        ...
        .inp-item
          ...
          .verification
            ...
            width: 17px;
            height: 17px;
            background: url(./ico2.png) no-repeat bottom;
            background-size: contain;
            margin: 2px 0 0 -25px;
            /* float left
            display inline
